    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-black text-white relative">
      ...
      <main className="flex flex-col items-center justify-center w-full max-w-4xl px-6 py-20 text-center z-10">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 text-zinc-100">
          {t("Translate documents", "Traduce documentos")} <br className="hidden md:block" />
          <span className="text-zinc-500">
            {t("into your language.", "a tu idioma.")}
          </span>
        </h1>

        <p className="text-lg md:text-xl text-zinc-400 mb-12 max-w-2xl leading-relaxed">
          {t(
            "We know to get a document translated for basic transition purposes can be hard so with our free website we get rid of the monetary hump no one wants to deal.",
            "Sabemos que traducir un documento para propósitos básicos puede ser difícil, por eso con nuestro sitio web gratuito eliminamos el obstáculo económico con el que nadie quiere lidiar."
          )}
        </p>
